...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Fence.id'
        db.alter_column(u'api_fence', 'id', self.gf('django.db.models.fields.CharField')(max_length=128, primary_key=True))

    def backwards(self, orm):

        # Changing field 'Fence.id'
        db.alter_column(u'api_fence', u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True))
