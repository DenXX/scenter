...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ScenterUser.userpic'
        db.alter_column(u'api_scenteruser', 'userpic', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'ScenterUser.userpic'
        db.alter_column(u'api_scenteruser', 'userpic', self.gf('django.db.models.fields.files.ImageField')(default='', max_length=100))
